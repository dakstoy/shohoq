                ...
                If Not IsNothing(ctl.Parent) Then
                    ...
                    Try
                        ...
                        If (ret) Then
                            ...
                            'f = Form2.Label1.Font
                            'fontRatioW = Form2.Label1.Width / c.originalWidth
                            'fontRatioH = Form2.Label1.Height / c.originalHeight
                            'fontRatio = (fontRatioW +
                            'fontRatioH) / 3 '-- average change in control Height and Width
                            'Form2.Label1.Font = New Font(f.FontFamily,
                            'c.originalFontSize * fontRatio, f.Style)

                            'f = Form2.Label2.Font
                            'fontRatioW = Form2.Label2.Width / c.originalWidth
                            'fontRatioH = Form2.Label2.Height / c.originalHeight
                            'fontRatio = (fontRatioW +
                            'fontRatioH) '-- average change in control Height and Width
                            'Form2.Label2.Font = New Font(f.FontFamily,
                            'c.originalFontSize * fontRatio, f.Style)
